...
raw_data <- read_csv("raw_census.csv")
dict <- read_lines("gss_dic_finalproject.txt", skip = 18) # skip is because of preamble content
# Now we need the labels because these are the actual responses that we need
labels_raw <- read_file("gss_labels_fianlproject.txt")
